...
default : 
	rm -f paper.aux && lhs2TeX --agda --poly paper.lagda -o paper.tex && pdflatex paper.tex && bibtex paper.aux && pdflatex paper.tex && pdflatex paper.tex
all : 
	lhs2TeX --agda --poly paper.lagda -o paper.tex && pdflatex paper.tex && bibtex paper.aux && pdflatex paper.tex && pdflatex paper.tex
